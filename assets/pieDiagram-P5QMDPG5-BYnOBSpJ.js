import{r as e}from"./chunk-35ZOQMXA-CyDLOecq.js";import{M as t,N as n,T as r,n as i}from"./chunk-OHNBJXQ2-a68LuocA.js";import{$ as a,C as o,E as s,J as c,Y as l,b as u,l as d,m as f,o as p,x as m}from"./chunk-KMA2NSDO-3VkbxxOP.js";import"./chunk-445WJIJ4-4_n40hzO.js";import{h,i as g}from"./chunk-TI7YOFXF-BB3SLjPc.js";import{o as _}from"./md-D1owfmdX.js";import{t as v}from"./chunk-X67BZSRO-BW30XYDA.js";import{M as y}from"./chunk-YOWFEKIV-D_K_T3CO.js";var b=f.pie,x={sections:new Map,showData:!1,config:b},S=x.sections,C=x.showData,w=structuredClone(b),T={getConfig:e(()=>structuredClone(w),`getConfig`),clear:e(()=>{S=new Map,C=x.showData,p()},`clear`),setDiagramTitle:a,getDiagramTitle:s,setAccTitle:l,getAccTitle:m,setAccDescription:c,getAccDescription:u,addSection:e(({label:e,value:t})=>{if(t<0)throw Error(`"${e}" has invalid value: ${t}. Negative values are not allowed in pie charts. All slice values must be >= 0.`);S.has(e)||(S.set(e,t),r.debug(`added new section: ${e}, with value: ${t}`))},`addSection`),getSections:e(()=>S,`getSections`),setShowData:e(e=>{C=e},`setShowData`),getShowData:e(()=>C,`getShowData`)},E=e((e,t)=>{v(e,t),t.setShowData(e.showData),e.sections.map(t.addSection)},`populateDb`),D={parse:e(async e=>{let t=await y(`pie`,e);r.debug(t),E(t,T)},`parse`)},O=e(e=>`
  .pieCircle{
